...
class FourierTransform(IndexRegressionModel):
    ...
    def __init__(self, model_options, input_options, stock_code, load=False, saved_model_dir=None, saved_model_path=None):
        ...
        if not load or saved_model_dir is None:
            ...
            if model_path is not None:
                self.load_model(path.join(saved_model_dir, model_path), self.CUSTOM_MODEL)
    ...
    def update_models_data(self, models_data, model_name, model_path):
        ...
        Models data dict format:
        {
            "models": {
                "<stock_code1>": {
                    "<model_type_hash1>": [
                        {"model_name": "model 1 name", "model_path": "model 1 path", "model": "fourier_transform"},
                        {"model_name": "model 2 name", "model_path": "model 2 path", "model": "fourier_transform"},
                        ...
                    ],
                    "<model_type_hash2>": [...],
                    ...
    ...
    def get_all_models(stock_code, saved_model_dir):
        ...
        for model_type in models_data["models"][stock_code]:
            models.append(FourierTransform(
